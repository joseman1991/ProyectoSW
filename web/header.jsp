...
<html>
    ...
    <body>
        ...
        <header class="header1" style="color: black">
            <!-- Header desktop -->
            <div class="container-menu-header" style="background: black">
                <div class="wrap_header" style="background: black">
                    <!-- Logo -->
                    ...
                    <div class="wrap_menu">
                        <nav class="menu">
                            <ul class="main_menu" >
                                <li>
                                    <a href="<s:property value="#index"/>" class="text-primary">Inicio</a>
                                </li>

                                <li>
                                    <a href="<s:property value="#pro"/>" class="text-primary">Articulos</a>
                                    <s:if test="#user!=null">
                                        <s:if test="#user.idperfil==1"><ul class="sub_menu">
                                                ...
                                                <li>
                                                    ...
                                                    <li>
                                                        <a href="<s:property value="#pro2"/>" class="text-primary">Mis Productos</a>                                    
                                                </li>
                                                <li>
                                                    <a href="<s:property value="#pro"/>" class="text-primary">Tienda</a>                                    
                                                </li>
                                ...
                                <s:if test="#user!=null">
                                    <li class="text-primary">
                                        ...
                                        <ul class="sub_menu">
                                            <li>
                                                <a href=" <s:property value="#reservas"/>" class="text-primary">Ventas</a>
                                            </li>

                                            <li>
                                                <a href=" <s:property value="#reservas1"/>" class="text-primary">Compras</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href=" <s:property value="#actu"/>" class="text-primary">Congiguracion de usuario</a>
                                    </li>
                                ...
                                <s:else>
                                    <a href="registro.jsp" class="text-primary">Registro</a>
                                </s:else>
                    ...
                    <!-- Header Icon -->
                    <div class="header-icons text-primary">
